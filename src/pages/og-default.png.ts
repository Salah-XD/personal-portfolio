...
export async function GET() {
  const markup = html(`
    <div style="display:flex;flex-direction:column;width:1200px;height:630px;background:#0f172a;color:#f1f5f9;padding:80px;font-family:JetBrains Mono;justify-content:center;align-items:flex-start;border:8px solid #10b981;">
      <div style="font-size:32px;color:#34d399;margin-bottom:32px;">salah@portfolio:~$ whoami</div>
      <div style="font-size:84px;line-height:1.05;font-weight:700;color:#f8fafc;letter-spacing:-2px;">MD Salah</div>
      <div style="font-size:36px;line-height:1.3;color:#cbd5e1;margin-top:24px;">Developer · Designer · Engineer</div>
      ...
      <div style="font-size:28px;color:#f8fafc;margin-top:8px;">Building digital experiences that matter.</div>
    </div>
  `);
