...
import { Moon, Sun, Terminal, Code, Palette, Briefcase, Mail, Github, Linkedin, Twitter, GitBranch, Star, Users, Zap, Activity, TrendingUp, ArrowRight } from 'lucide-react';
...
function Portfolio() {
  ...
  const fullText = "Hello, I'm MD Salah - founder, developer, designer & engineer";
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'live': return isDark ? 'text-emerald-400' : 'text-emerald-600';
      case 'development': return isDark ? 'text-amber-400' : 'text-amber-600';
      case 'archived': return isDark ? 'text-slate-400' : 'text-slate-500';
      default: return isDark ? 'text-emerald-400' : 'text-emerald-600';
    }
  };
    ...
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <header className={`fixed top-0 w-full z-50 backdrop-blur-sm border-b transition-colors duration-300 ${
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2 font-mono">
            ...
            <span className={`${isDark ? 'text-emerald-400' : 'text-slate-600'}`}>
          ...
          <nav className="hidden md:flex items-center space-x-8 font-mono text-sm">
            <button 
              ...
              className={`hover:${isDark ? 'text-emerald-400' : 'text-slate-600'} transition-colors`}
            >
              ./about
            </button>
            <button 
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className={`font-mono text-sm mb-8 ${isDark ? 'text-emerald-400' : 'text-slate-500'}`}>
          ...
          <p className={`font-mono text-lg leading-relaxed max-w-2xl ${
            isDark ? 'text-slate-300' : 'text-slate-600'
          }`}>
            Building digital experiences that matter. I create, code, design, and lead 
            with a focus on simplicity and impact.
          </p>
          
          <div className={`mt-8 font-mono text-sm ${isDark ? 'text-emerald-400' : 'text-slate-500'}`}>
            guest@portfolio:~$ cat status.txt<br/>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className={`p-6 border rounded-lg transition-all duration-300 hover:scale-105 ${
                isDark 
                  ? 'border-slate-700 bg-slate-800/50 hover:border-slate-600' 
                  : 'border-slate-200 bg-white hover:border-slate-300'
              }`}>
                <Briefcase className={`w-8 h-8 mb-4 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
                <h3 className="font-mono text-xl mb-2">Founder</h3>
                <p className={`${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                  Building companies from 0 to 1. Strategic vision meets execution.
                </p>
              </div>
              ...
              <div className={`p-6 border rounded-lg transition-all duration-300 hover:scale-105 ${
                ...
                <Code className={`w-8 h-8 mb-4 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
            ...
            <div className="space-y-8">
              <div className={`p-6 border rounded-lg transition-all duration-300 hover:scale-105 ${
                ...
                <Palette className={`w-8 h-8 mb-4 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
              ...
              <div className={`p-6 border rounded-lg transition-all duration-300 hover:scale-105 ${
                ...
                <Terminal className={`w-8 h-8 mb-4 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-2">
                    <GitBranch className={`w-4 h-4 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
                    <span className="font-mono text-lg">{project.name}</span>
                    <span className={`font-mono text-sm px-2 py-1 rounded ${getStatusColor(project.status)}`}>
                      {project.status}
                    </span>
                  </div>
                  
                  <p className={`${isDark ? 'text-slate-300' : 'text-slate-600'} mb-2 ml-8`}>
                    {project.description}
                  </p>
                  ...
                  <div className="flex items-center space-x-4 ml-8">
                    ...
                    <span className={`font-mono text-sm ${isDark ? 'text-emerald-400' : 'text-slate-500'}`}>
                      {project.impact}
                    </span>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-2 mb-6">
              {['all', 'languages', 'frontend', 'backend', 'architecture', 'design', 'business'].map((category) => (
                <button
                  key={category}
              ...
              {filteredSkills.map((skill) => (
                <div key={skill.name} className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`font-mono text-sm ${isDark ? 'text-emerald-400' : 'text-slate-600'}`}>
                      {skill.level}%
                    </span>
                  </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className={`text-center p-6 border rounded-lg ${
              ...
              <Users className={`w-8 h-8 mx-auto mb-2 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
              <div className="font-mono text-2xl mb-1">50k+</div>
              <div className={`font-mono text-sm ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                Users Impacted
              </div>
            </div>
            ...
            <div className={`text-center p-6 border rounded-lg ${
              ...
              <Star className={`w-8 h-8 mx-auto mb-2 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
            ...
            <div className={`text-center p-6 border rounded-lg ${
              ...
              <Zap className={`w-8 h-8 mx-auto mb-2 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
            ...
            <div className={`text-center p-6 border rounded-lg ${
              ...
              <TrendingUp className={`w-8 h-8 mx-auto mb-2 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
          ...
          <div className={`mt-12 p-6 border rounded-lg font-mono text-sm ${
            isDark 
              ? 'border-slate-700 bg-slate-800/30' 
              : 'border-slate-200 bg-white'
          }`}>
            <div className={`mb-4 ${isDark ? 'text-emerald-400' : 'text-slate-700'}`}>
              System Status: OPERATIONAL
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <div className={`${isDark ? 'text-slate-300' : 'text-slate-600'}`}>CPU Usage</div>
                <div className="flex items-center space-x-2">
                  <Activity className={`w-4 h-4 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
                  <span>85% (Optimal)</span>
                </div>
              </div>
              <div>
                <div className={`${isDark ? 'text-slate-300' : 'text-slate-600'}`}>Memory</div>
                <div className="flex items-center space-x-2">
                  <Activity className={`w-4 h-4 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
                  <span>12GB / 16GB</span>
                </div>
              ...
              <div>
                <div className={`${isDark ? 'text-slate-300' : 'text-slate-600'}`}>Network</div>
                <div className="flex items-center space-x-2">
                  <Activity className={`w-4 h-4 ${isDark ? 'text-emerald-400' : 'text-slate-600'}`} />
                  <span>1.2GB/s</span>
                </div>
          ...
          <div className="space-y-6">
            {[
              ...
              >
                ...
                <h3 className={`font-mono text-xl mb-3 hover:${isDark ? 'text-emerald-400' : 'text-slate-600'} transition-colors`}>
                  {post.title}
                </h3>
      ...
      <section id="contact" className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className={`font-mono text-lg mb-12 ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
      ...
      <footer className={`border-t py-8 ${
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className={`font-mono text-sm ${isDark ? 'text-emerald-400' : 'text-slate-500'}`}>
